      ...
      <div className="mx-auto flex w-full max-w-[980px] flex-col gap-12 text-lg">
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
            <ScreenshotPopover
              src="/images/ScalesPage.png"
              alt="Scales page screenshot"
              openLabel="Scales"
            />
            <div className="lg:flex-1">
              <ul className="list-disc space-y-1 pl-5 leading-relaxed text-slate-300">
                ...
                <li>
                  By default, scales will start at the bottom of your range (as defined in settings)
                  and increment up one semitone each repeat.
                </li>
                <li>
                  When the scale repeats reach the top of your range they will start descending
                  again.
                </li>
                <li>
                ...
                <li>
                  In the settings you can define your vocal range. That affects the visible piano
                  keys and the limits for the scales.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
            <ScreenshotPopover
              src="/images/PitchPage.png"
              alt="Pitch page screenshot"
              openLabel="Pitch"
            />
            <ul className="list-disc space-y-1 pl-5 leading-relaxed text-slate-300 lg:flex-1">
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
            <ScreenshotPopover
              src="/images/VibratoPage.png"
              alt="Vibrato page screenshot"
              openLabel="Vibrato"
            />
            <ul className="list-disc space-y-1 pl-5 leading-relaxed text-slate-300 lg:flex-1">
        ...
        <p className="leading-relaxed text-slate-300">
          The Spectrogram, Pitch, and Vibrato pages are all linked, so you can switch between them
          to see different views of your voice, while playing or while paused.
        </p>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
            ...
            <div className="space-y-4 lg:flex-1">
              ...
              <ul className="list-disc space-y-1 pl-5 leading-relaxed text-slate-300">
                <li>
                  <strong>Keep running in background</strong>: continue recording when app loses
                  focus.
                </li>
                <li>
              ...
              <ul className="list-disc space-y-1 pl-5 leading-relaxed text-slate-300">
                <li>
                  <strong>Run at 30 FPS</strong>: lowers frame rate to reduce battery use. This
                  makes quite a big difference to battery use and is barely noticeable.
                </li>
                <li>
                  <strong>Half-resolution canvas</strong>: lowers chart render resolution for lower
                  CPU/GPU use.
                </li>
                <li>
                  <strong>Half-resolution spectrogram</strong>: halves spectrogram resolution to
                  reduce processing cost. This doesn't affect the pitch detection algorithm.
                </li>
                <li>
                  <strong>Battery use</strong>: estimated battery drain rate (<code>%/min</code>).
                  Shows <code>NA</code> when battery stats are unavailable. This reading only makes
                  sense if Voicebox is the only app you're using and it stays active. It updates
                  once per minute.
                </li>
              </ul>
            </div>
